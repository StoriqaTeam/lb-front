  	...
  	return(
  			<div className='social-login'>
				        ...
				        <div className="flex-c-m">
				          <a href={`${API_URL}/auth/facebook`} className="login100-social-item" target='_blank'>
				            <img src="/src/img/icons/fb2.png" className='popup__button_fb'/>
				          </a>     
				          <a href={`${API_URL}/auth/twitter/callback`} className="login100-social-item social-login__twitter" target='_blank'>
				          ...
				          <a href={`${API_URL}/auth/google`} target='_blank' className="login100-social-item">
				            <img src="/src/img/icons/google.svg" />
				          </a>
				          <a href={`${API_URL}/auth/tg`} target='_blank' className="login100-social-item social-login__telegram">
